package net.sciencestudio.autodialogfx.old.tests;
...
import net.sciencestudio.autodialogfx.old.AutoDialog;
...
import net.sciencestudio.autodialogfx.old.model.value.bounded.IBoundedValue;
import net.sciencestudio.autodialogfx.old.model.value.list.IListValue;
import net.sciencestudio.autodialogfx.old.model.value.list.ListValue;
import net.sciencestudio.autodialogfx.old.view.decor.SeparatorDecor;
import net.sciencestudio.autodialogfx.old.view.editors.CheckboxEditor;
import net.sciencestudio.autodialogfx.old.view.editors.ChoiceBoxEditor;
import net.sciencestudio.autodialogfx.old.view.editors.FilenameEditor;
import net.sciencestudio.autodialogfx.old.view.editors.SliderIntegerEditor;
import net.sciencestudio.autodialogfx.old.view.editors.TextAreaEditor;
import net.sciencestudio.autodialogfx.old.view.editors.TextFieldEditor;
import net.sciencestudio.autodialogfx.old.view.layouts.LabeledLayout;
import net.sciencestudio.autodialogfx.old.view.layouts.TabbedLayout;
